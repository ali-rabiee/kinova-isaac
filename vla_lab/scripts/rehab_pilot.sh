...
#   PARTICIPANTS=24 ALL_CONDITIONS=1 ./vla_lab/scripts/rehab_pilot.sh
#   MISDETECT=0.15 ./vla_lab/scripts/rehab_pilot.sh      # W8 stress test: bad online labels
...
OUT_DIR="${OUT_DIR:-vla_lab/results/rehab_phase0}"
FORMAT="${FORMAT:-pdf}"
CONFIG="${CONFIG:-vla_lab/configs/rehab_sim_pilot.yaml}"
...
exec python -m vla_lab.rehab.run_pilot \
