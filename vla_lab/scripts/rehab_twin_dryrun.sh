...
#   GUI=1 ./vla_lab/scripts/rehab_twin_dryrun.sh
#   GEOMETRY_ONLY=1 ./vla_lab/scripts/rehab_twin_dryrun.sh
...
CONFIG="${CONFIG:-vla_lab/configs/rehab_twin.yaml}"
OUT_DIR="${OUT_DIR:-vla_lab/results/rehab_phase0/twin}"
