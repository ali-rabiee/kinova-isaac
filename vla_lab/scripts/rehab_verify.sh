...
#
#   ./vla_lab/scripts/rehab_verify.sh logs/rehab/participant_P001/session_20260901_101500
#   ./vla_lab/scripts/rehab_verify.sh --root logs/rehab --pool     # + poolability across sessions
...
exec python -m vla_lab.rehab.verify_session "$@"
