...
#
#   ./vla_lab/scripts/rehab_analyze.sh
#   SESSION_ROOT=logs/rehab FIGURES_DIR=vla_lab/paper/figures ./vla_lab/scripts/rehab_analyze.sh
#   OFFPOLICY=1 ./vla_lab/scripts/rehab_analyze.sh   # + the model-based secondary analysis (§12.6)
#
...
exec python -m vla_lab.rehab.analyze \
