...
- vla_lab.verify_session : post-collection session validator (run before training!)
- vla_lab.repair_gripper_labels : backfill gripper labels in pre-2026-06 sessions
"""
