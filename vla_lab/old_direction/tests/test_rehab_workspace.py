"""W1 — tests for ``vla_lab.old_direction.rehab.workspace`` and ``vla_lab.old_direction.rehab.contract``.
...
from vla_lab.old_direction.rehab.workspace import (
    SIDE_LEFT,
    SIDE_RIGHT,
    PlanarTransform,
    TargetGrid,
...
def test_contract_rejects_an_impossible_budget():
    from vla_lab.old_direction.rehab.contract import BudgetConfig
