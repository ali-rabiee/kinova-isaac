...
is a real synthetic run through :class:`~vla_lab.old_direction.rehab.session.Phase0Session`, so the gate is
...
from vla_lab.old_direction.rehab import ASSESS, COACH, WAIT
from vla_lab.old_direction.rehab.contract import BudgetConfig, Phase0Contract
from vla_lab.old_direction.rehab.logging import SessionReader
from vla_lab.old_direction.rehab.protocol import BLOCK_COMPARED, BLOCK_REFERENCE, BLOCK_RETEST, Phase0Protocol
from vla_lab.old_direction.rehab.run_pilot import run_one, synthetic_handedness
from vla_lab.old_direction.rehab.scheduler import COMPARED_CONDITIONS
from vla_lab.old_direction.rehab.verify_session import Thresholds, verify_pool, verify_session
...
def test_the_handedness_inventory_gates_the_session():
    from vla_lab.old_direction.rehab.apparatus import NullApparatus
    from vla_lab.old_direction.rehab.session import Phase0Session, SessionConfig
...
def test_fixture_low_observer_agreement_fails_the_gate():
    from vla_lab.old_direction.rehab import ARM_NONPREFERRED, ARM_PREFERRED
    from vla_lab.old_direction.rehab.logging import OBSERVERS_FILE
...
def test_the_analysis_runs_on_a_synthetic_session():
    from vla_lab.old_direction.rehab.analyze import ParticipantData, aggregate, analyze_participant
    from vla_lab.old_direction.rehab.carryover import CarryoverConfig
