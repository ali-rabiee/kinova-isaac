"""W2 — tests for ``vla_lab.old_direction.rehab.trial`` and ``vla_lab.old_direction.rehab.logging``.
...
from vla_lab.old_direction.rehab import ARM_NONPREFERRED, ASSESS, COACH, WAIT
from vla_lab.old_direction.rehab.contract import Phase0Contract, TimingConfig
from vla_lab.old_direction.rehab.logging import (
    CONTRACT_FILE,
    OBSERVERS_FILE,
    PROTOCOL_FILE,
    SessionReader,
...
from vla_lab.old_direction.rehab.trial import (
    PHASE_DWELL,
    PHASE_GO,
    PHASE_LOG,
    PHASE_PRESENT,
