"""W7 — tests for ``vla_lab.old_direction.rehab.protocol``.
...
from vla_lab.old_direction.rehab.protocol import (
    BLOCK_COMPARED,
    BLOCK_REFERENCE,
    BLOCK_RETEST,
    Phase0Protocol,
...
from vla_lab.old_direction.rehab.scheduler import COMPARED_CONDITIONS, CONDITION_NO_PROMPT
...
def test_validate_catches_a_coach_leaking_into_the_reference_block():
    from vla_lab.old_direction.rehab.protocol import SlotSpec
