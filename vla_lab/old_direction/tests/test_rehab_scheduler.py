"""W5 — tests for ``vla_lab.old_direction.rehab.scheduler``.
...
from vla_lab.old_direction.rehab.protocol import Phase0Protocol, generate_session_plan
from vla_lab.old_direction.rehab.scheduler import (
    ALL_CONDITIONS,
    COMPARED_CONDITIONS,
...
from vla_lab.old_direction.rehab.scheduler.base import DeltaModel
from vla_lab.old_direction.rehab.scheduler.carryover_aware import population_washout_slots
from vla_lab.old_direction.rehab.trial import History, Trial, TrialRecord, TrialResult
