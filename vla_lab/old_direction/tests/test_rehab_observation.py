"""W8 — tests for ``vla_lab.old_direction.rehab.observation`` (+ W13 calibration).
...
from vla_lab.old_direction.rehab import ARM_AMBIGUOUS, ARM_NONE, ARM_NONPREFERRED, ARM_PREFERRED
from vla_lab.old_direction.rehab.observation import (
    KAPPA_ACCEPTANCE,
    CompositeObserver,
    KeyedObserver,
...
from vla_lab.old_direction.rehab.observation.vision import HandObservation
...
def test_mediapipe_adapter_refuses_to_pretend():
    from vla_lab.old_direction.rehab.observation.vision import MediaPipeHandDetector
...
def test_ingesting_coded_labels_appends_and_never_rewrites():
    from vla_lab.old_direction.rehab.logging import OBSERVERS_FILE, SessionWriter
    from vla_lab.old_direction.rehab.observation.coding import ingest_coded_labels
...
def test_the_calibration_gate_refuses_a_sloppy_midline():
    from vla_lab.old_direction.rehab.observation.calibration import CalibrationBundle, ParticipantFrame
