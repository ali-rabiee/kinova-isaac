"""W4 — tests for ``vla_lab.old_direction.rehab.estimand``.
...
from vla_lab.old_direction.rehab import ASSESS, COACH
...
from vla_lab.old_direction.rehab.estimand import (
    METHOD_CORRECTED,
    METHOD_POOLED,
    METHOD_SPATIAL,
...
from vla_lab.old_direction.rehab.workspace import nonpreferred_lateral
...
def test_joint_posterior_beats_the_online_plugin_at_recovering_the_effect():
    ...
    from vla_lab.old_direction.rehab.carryover import CarryoverPosterior
...
def test_metrics_match_hand_computed_values():
    from vla_lab.old_direction.rehab.estimand import PiStarPosterior, _prob_grid
