"""W6 — tests for ``vla_lab.rehab.sim_participant``.
...
from vla_lab.rehab import ARM_NONPREFERRED, ARM_PREFERRED, ASSESS, COACH, WAIT
from vla_lab.rehab.contract import Phase0Contract
from vla_lab.rehab.sim_participant import (
    PopulationPrior,
    SimulatedObserver,
    SimulatedParticipant,
    draw_participant,
)
from vla_lab.rehab.workspace import SIDE_LEFT, SIDE_RIGHT, nonpreferred_lateral
