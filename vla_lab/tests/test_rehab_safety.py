"""W12 — tests for ``vla_lab.rehab.safety`` and the apparatus backends.
...
from vla_lab.rehab.apparatus import FakeGen2Driver, KinovaGen2Apparatus, LoopbackTransport, NullApparatus
from vla_lab.rehab.apparatus.base import (
    HALT_DRIVER_FAULT,
    HALT_DWELL_TIMEOUT,
...
from vla_lab.rehab.apparatus.isaac_apparatus import ParticipantProxy, check_trajectories, straight_line_waypoints
from vla_lab.rehab.contract import Phase0Contract
from vla_lab.rehab.safety import (
    SOURCE_EXPERIMENTER,
    SOURCE_PARTICIPANT,
    STATE_GO_ISSUED,
    STATE_HALTED,
...
from vla_lab.rehab.trial import ManualClock, SessionClock
